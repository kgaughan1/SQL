...
/* SELECT tbl_species.species_name FROM tbl_species WHERE species_order = 3; */

/*SELECT tbl_nutrition.nutrition_type FROM tbl_nutrition WHERE nutrition_cost < 600; */

/*SELECT tbl_species.species_name, tbl_species.species_nutrition  FROM tbl_species WHERE tbl_species.species_nutrition >= 2202 AND tbl_species.species_nutrition <= 2206; */

SELECT * FROM tbl_species;



/*SELECT tbl_species.species_name AS 'Species Name', tbl_nutrition.nutrition_type AS 'Nutrition Type' FROM tbl_species, tbl_nutrition;/*